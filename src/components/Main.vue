<template>
    <div class="principal">
        ...
        <b-row>
            <b-button size="sm" class="my-2 my-sm-0" type="submit"    v-on:click="filtraPorValor">
                Filtra 5 estrelas
            </b-button>
        </b-row>
            ...
            <b-row cols="3" offset-md="3">
                <div
                    ...
                    <div class="col-md-6">
                        ...
                        <b-card-text>
                        {{ carro.valor |  formatar("R$")}}
                        </b-card-text>
                        <!-- <a :href="carro.url"--> <a class="btn btn-warning">Avaliar</a> 
                        </div>
                    </div>
                    </div>
                </div>
...
export default {
    ...
    data: function(){
        return{
            mostrarCarros: true,
            title: "Estacionamento de Luxo e itens de coleção!",
    ...
    methods: { 
        filtraPorValor(){
            this.carro = this.carros.filter(elem => elem.valor === 700000)
            return this.carros
        }
    },
}
